...
def binary_prec_rec(g1_num_of_pos, g1_num_of_neg, g2_num_of_pos, g2_num_of_neg):
    prec = g1_num_of_pos / (g1_num_of_pos + g1_num_of_neg)
    rec = g1_num_of_pos / (g1_num_of_pos + g2_num_of_neg)
    return prec, rec
